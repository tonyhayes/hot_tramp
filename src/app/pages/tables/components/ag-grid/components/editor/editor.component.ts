...
@Component({
	...
	template: `
		<div #container class="mood" tabindex="0" (keydown)="onKeyDown($event)">
			<img src="app/pages/tables/components/ag-grid/images/smiley.png" (click)="setHappy(true)" [ngClass]="{'selected' : happy, 'default' : !happy}">
			<img src="app/pages/tables/components/ag-grid/images/smiley-sad.png" (click)="setHappy(false)" [ngClass]="{'selected' : !happy, 'default' : happy}">
		</div>
	`,
	styles: [`
		.mood {
...
export class MoodRendererComponent implements AgRendererComponent {
	...
	private setMood(params) {
		...
		this.imgForMood = this.mood === 'Happy' ? 'app/pages/tables/components/ag-grid/images/smiley.png' : 'app/pages/tables/components/ag-grid/images/smiley-sad.png';
	};
}
